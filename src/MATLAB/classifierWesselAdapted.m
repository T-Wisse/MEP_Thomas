...
for ii=1:17
    ...
    geneEndCoordinatesConcat(geneChromosomeLoc==ii) = geneEndCoordinatesConcat(geneChromosomeLoc==ii)+lengthPreviousChr(ii); %Translate all gene start coordinates to a total bp. 
end
...
TestTable_DplI = table(tnPerGeneMinTen, readPerGeneMinTen, geneLength, tndensityT, tnFreeIntervalPerGeneLength);% 
