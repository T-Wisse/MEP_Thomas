...
query.add_view(
    "symbol", "goAnnotation.ontologyTerm.name", "goAnnotation.qualifier",
...
query.add_constraint("goAnnotation.ontologyTerm.parents.name", "=", GO_term, code="A")
...
for row in query.rows():
    print(row["symbol"], row["goAnnotation.ontologyTerm.name"], row["goAnnotation.qualifier"], \
        row["goAnnotation.ontologyTerm.parents.name"])

#%% Get genes: cell polarity
...
#%% Get genes cell polarity (DOUBLE)
...
# query.add_constraint("status", "IS NULL", code="F")
# query.add_constraint("organism.name", "=", "Saccharomyces cerevisiae", code="B")
# query.add_constraint("goAnnotation.ontologyTerm.parents.name", "=", "establishment of cell polarity", code="A")
